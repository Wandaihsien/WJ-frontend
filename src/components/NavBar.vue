...
watch([() => isMenuOpen.value, () => isCartOpen.value], ([menuOpen, cartOpen]) => {
...
<template>
  <div class="shadow-[0_4px_6px_rgba(0,0,0,0.05)] sticky top-0 z-10">
    ...
    <Transition :name="slideChanged" >
      <div v-if="isCartOpen" class="w-[30vw] h-screen bg-white absolute overflow-y-auto z-[1000] will-change-transform
      lg:right-[5vw] lg:top-[18vh] lg:max-w-[300px] lg:h-auto lg:min-h-[136px] lg:max-h-[80vh]">
        <div class="w-full p-[15px] flex gap-[15px] relative after:content-[''] after:block after:w-full after:h-[1px] after:bg-gray-200 after:absolute after:bottom-0 after:left-0">
          <div class="w-[20%] min-w-[33px] max-w-[70px] aspect-square">
            <img src="/src/img/barcelet.jpg" alt="" class="object-cover">
          </div>
          <div class="w-[60%] min-w-[115px] flex flex-col justify-between">
            <div class="text-[1.3vw] text-gray-400
            lg:text-[0.8vw]">8mm山度士手鍊</div>
          ...
          <div class="w-[10%] absolute right-[10px] bottom-[20px]">
            <TrashCan class="size-[1.5vw] lg:size-[1vw]"/>
          </div>
        </div>

        <div class="w-full mb-[10px] flex justify-center items-center absolute bottom-0
        lg:mb-0 lg:relative">
    ...
    <div class="w-full h-[34.56px] bg-red-800">
      <a href="#" class="h-full flex items-center justify-center">
        <p class="text-white text-xs inline-block">新會員註冊送$100購物金</p>
      </a>
    </div>
    <nav class="w-full">
      <div class="w-full h-[60px] flex bg-white">
        <div class="w-1/2 flex items-center">
          <a href="#" class="ml-[20px]">
            <img src="/src/img/WJ.jpg" class="w-[30px] h-[30px]" alt="">
          </a>
        </div>
        <div class="w-1/2 flex items-center justify-end">
          <ul class="flex">
            <li class="pl-[10px] pr-[10px]">
              <RouterLink to="/Users">
            ...
            <li @click="isCartOpen = !isCartOpen" class="pl-[10px] pr-[10px] relative z-10 md:pr-[25px]">
              <a href="#">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 h-[60px]">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 0 1-1.12-1.243l1.264-12A1.125 1.125 0 0 1 5.513 7.5h12.974c.576 0 1.059.435 1.119 1.007ZM8.625 10.5a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm7.5 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
                </svg>
                <span class="absolute top-[26px] left-[19px] text-xs">0</span>
              </a>
            </li>
